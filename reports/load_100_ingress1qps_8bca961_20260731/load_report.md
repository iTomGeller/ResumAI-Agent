...
> **历史报告**：本文保留修复前 1 QPS 入口压测与中间 A/B 过程。当前线上版本 `f89ab83`、Run 8 / LLM 16 的最终 100 份复压结论以 [final_100_f89ab83_20260731/load_report.md](../final_100_f89ab83_20260731/load_report.md) 为准，不再使用本文的旧容量结论。
