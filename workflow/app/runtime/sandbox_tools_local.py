"""Deterministic resume-analysis tools executed inside the Docker sandbox.

This module is the single source of truth: the sandbox worker image copies it
verbatim (see sandbox/worker/), and unit tests import it directly. It must
stay dependency-light (stdlib + optional pypdf) and never perform network IO.
"""
